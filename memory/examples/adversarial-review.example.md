...
The draft being reviewed (deliverables/series-b-narrative-v0.3.md) is referenced
but does not need to exist as a separate file for this example — the review
output below references its content inline.
-->

## File: `deliverables/series-b-narrative-v0.3.md`
