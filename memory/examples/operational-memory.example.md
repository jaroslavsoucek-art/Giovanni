...
5. **Series B narrative gap** — need €3M ARR + NR >115% inflection story; current ARR trajectory €1.2M → €1.8M projected by Series B prep. Story-stretching candidates pending validation.
...
Detail in `knowledge/lattice_operating_principles.md`. Top-of-mind facts:
...
- **Design partner 1 new CFO contact** (name TBD post 2026-05-27 intro) — bootstrap immediately after first call
...
- **GitHub:** `lattice-finance/` org, main monorepo `lattice-platform`.

---

## System hygiene

- **Monthly memory audit** — last: 2026-05-04. Next due ~2026-06-08 (cadence 35d).
- **Light prune** — last: 2026-05-19. Next due ~2026-06-02 (cadence 14d).
- **Watch scan** — last: 2026-05-20. Next due ~2026-05-27 (cadence 7d).
